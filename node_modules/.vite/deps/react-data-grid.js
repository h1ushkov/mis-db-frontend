...
// node_modules/react-data-grid/node_modules/clsx/dist/clsx.mjs
function r(e) {
  var t, f, n = "";
...
function getCellClassname(column, ...extraClasses) {
  return clsx_default(cellClassname, ...extraClasses, column.frozen && cellFrozenClassname, column.isLastFrozenColumn && cellFrozenLastClassname);
}
var {
  min,
  max,
...
function renderCheckbox({
  ...
  return (0, import_jsx_runtime.jsxs)("label", {
    className: clsx_default(checkboxLabelClassname, props.disabled && checkboxLabelDisabledClassname),
...
function SummaryRow({
  ...
  return (0, import_jsx_runtime.jsx)("div", {
    role: "row",
    "aria-rowindex": ariaRowIndex,
    className: clsx_default(rowClassname, `rdg-row-${rowIdx % 2 === 0 ? "even" : "odd"}`, summaryRowClassname, isTop ? [topSummaryRowClassname, showBorder && topSummaryRowBorderClassname] : ["rdg-bottom-summary-row", showBorder && bottomSummaryRowBorderClassname], selectedCellIdx === -1 && rowSelectedClassname),
    style: {
...
function DataGrid(props, ref) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    onKeyDown: handleKeyDown,
    "data-testid": testId,
    children: [(0, import_jsx_runtime.jsx)(DataGridDefaultRenderersProvider, {
      value: defaultGridComponents,
      children: (0, import_jsx_runtime.jsxs)(RowSelectionChangeProvider, {
        value: selectRowLatest,
        children: [(0, import_jsx_runtime.jsxs)(RowSelectionProvider, {
